...
//    Route::get( '/addDriver', ['as' => 'admin.addDriver', 'uses' => 'AdminController@addDriver'] );
//    Route::get( '/drivers', ['as' => 'admin.drivers', 'uses' => 'AdminController@drivers'] );
//    Route::post( '/drivers', ['as' => 'admin.storeDriver', 'uses' => 'AdminController@storeDriver'] );
...
//    Route::resource('admin', 'AdminController');
    ...
    Route::get( 'route/check', ['as' => 'trip.check', 'uses' => 'BusTripController@check'] );
    Route::get( 'trip/book', ['as' => 'trip.book', 'uses' => 'BusTripController@book'] );


//    Route::resource('trip', 'TripController');
//    Route::get( 'get/route', ['as' => 'trip.route', 'uses' => 'TripController@getRoute'] );
//    Route::get( 'get/route', ['as' => 'trip.route', 'uses' => 'TripController@getRoute'] );
//    Route::get( 'routes', ['as' => 'trip.route', 'uses' => 'TripController@getRoute'] );
//    Route::get( 'buses', ['as' => 'trip.bus', 'uses' => 'TripController@bus'] );


//    Route::get('routes', 'TripController@getRoute');
});
